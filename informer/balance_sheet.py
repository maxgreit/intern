...
from informer_modules.get_request import get_balance_sheet_dataframe
...
def main():
    ...
    # Jaren tussen 2024 en nu
    jaren_range = range(2024, int(time.strftime("%Y")) + 1)
    ...
    try:
        ...
        for jaar in jaren_range:
            ...
            # Data overdracht
            empty_and_fill_table(df, tabelnaam, greit_connection_string, jaar)
